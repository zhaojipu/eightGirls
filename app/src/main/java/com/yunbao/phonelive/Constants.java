...
public class Constants {
    ...
    public static final String PERSONALNAME="编辑昵称";
    public static final String PERSONALNAME_CONTEXT="请输入昵称";
    public static final int PERSONALNAME_TYPE=1;
    public static final String PERSONSIGN="个人签名";
    public static final String PERSONSIGN_CONTENT="请输入个人签名";
    public static final int PERSONSIGN_TYPE=2;
    public static final int PERSONCOUNTY_TYPE=3;
    public static final String PERSONCOUNTY="家乡";
    public static final String PERSONCOUNTY_CONTENT="请输入您的家乡";
    public static final int PERSONBUSINESS_TYPE=4;
    public static final String PERSONBUSINESS="编辑名片";
    public static final String PERSONBUSINESS_CONTENT="请输入联系方式 如:微信";
    ...
    public static final String LIVE_FUFEI="ChargeRoom";
