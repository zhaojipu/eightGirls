...
public class DuChangeViewholder extends AbsMainChildTopViewHolder {
    ...
    public DuChangeViewholder(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.duchang_home;
    }

    @Override
    public void init() {
        Log.e("MainHomeViewHolder", "DuChangeViewholder");
        super.init();
        String url = SpUtil.getInstance().getStringValue("gameUrl");
        L.e("H5--->" + url);
