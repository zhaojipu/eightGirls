...
public class ChargeLiveViewHolder extends AbsMainChildTopViewHolder implements OnItemClickListener<LiveBean> {
    ...
    public ChargeLiveViewHolder(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    @Override
    public void init() {
        Log.e("MainHomeViewHolder","ChargeLiveViewHolder");
        super.init();
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<LiveBean>() {
            ...
            public RefreshAdapter<LiveBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(ChargeLiveViewHolder.this);
                }
                return mAdapter;
            }
