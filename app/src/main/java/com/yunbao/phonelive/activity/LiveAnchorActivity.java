...
public class LiveAnchorActivity extends LiveActivity implements LiveFunctionClickListener {
    ...
    protected void main() {
        ...
        //添加开播前设置控件
        mLiveReadyViewHolder = new LiveReadyViewHolder(mContext, this, getSupportFragmentManager(), mContainer);
    ...
    public void startLiveSuccess(String data, int liveType, int liveTypeVal) {
        ...
        Log.e("mStreammStream", mStream + "--");
        Log.e("mStreammStream", mDanmuPrice + "--");
        Log.e("mStreammStream", mShutTime + "--");
        Log.e("mStreammStream", playUrl + "--");
