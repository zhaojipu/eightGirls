...
public class WebViewActivity extends AbsActivity {
    ...
    private int flag;
    private FrameLayout duchang_titlerbar;
    ...
    protected void main() {
        mIntent = getIntent();
        flag = mIntent.getIntExtra("duchang", 0);
        String url = mIntent.getStringExtra(Constants.URL);
        L.e("H5--->" + url);
        LinearLayout rootView = (LinearLayout) findViewById(R.id.rootView);
        duchang_titlerbar = findViewById(R.id.duchang_titlerbar);
        ...
        if (flag == 1) {
            setTitle("赌场");
            duchang_titlerbar.setVisibility(View.GONE);
        } else {
            duchang_titlerbar.setVisibility(View.VISIBLE);
        }
